...
class HomeafterclockinPage extends StatelessWidget {
  @override
...
class HomePageAfterClockIn extends StatefulWidget {
  @override
  _HomeScreenState createState() => _HomeScreenState();
}

class _HomeScreenState extends State<HomePageAfterClockIn> {
      ...
      children: [
        InkWell(
          onTap: () {
            ...
            Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => ClockOutApp()),
            );
          },
          child: Container(
            width: 148,
            ...
            decoration: BoxDecoration(
              gradient: RadialGradient(
                colors: [
                  Color(0xFFFFD83A), // Yellow color (center)
                  Color(0xFFFC5D38), // Red color (outer)
                ],
